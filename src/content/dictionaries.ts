...
export type LayoutDictionary = Pick<Dictionary, "nav" | "footer"> & {
  home: Pick<Dictionary["home"], "contact">;
};

export function pickLayoutDictionary(dictionary: Dictionary): LayoutDictionary {
  return {
    nav: dictionary.nav,
    footer: dictionary.footer,
    home: { contact: dictionary.home.contact },
  };
}
